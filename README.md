...
It verifies your API key against OpsCompanion endpoints automatically, trying production first and then development, and saves the working endpoint to config.
